...
export default function Preview({ componentId, projectId }: Props) {
  ...
  return <>{componentsData?.layout ? componentsData.layout.map((c) => parseUI(c)) : null}</>;
}
