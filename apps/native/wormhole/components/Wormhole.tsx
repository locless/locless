...
export type WormholeProps = {
    ...
    readonly shouldOpenWormhole?: (source: WormholeSource, options: WormholeOptions) => Promise<React.Component>;
};
...
export default function Wormhole({
    ...
    }, [shouldOpenWormhole, source, setComponent, forceUpdate, setError, dangerouslySetInnerJSX, onError]);
