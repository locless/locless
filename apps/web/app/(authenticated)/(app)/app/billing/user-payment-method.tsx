...
export function UserPaymentMethod({ paymentMethod }: Partial<UserPaymentMethodType>) {
  if (!paymentMethod) {
...
const CreditCard: React.FC<UserPaymentMethodType> = ({ paymentMethod }) => (
  <div className='aspect-[86/54] max-w-[320px] border border-gray-200 justify-between rounded-lg bg-gradient-to-tr from-gray-200/70 dark:from-black to-gray-100 dark:to-gray-900 dark:border dark:border-gray-800 shadow-lg p-8 '>
    <div className='mt-16 font-mono text-content whitespace-nowrap'>•••• •••• •••• {paymentMethod.card?.last4}</div>
...
const StripeLink: React.FC<UserPaymentMethodType> = ({ paymentMethod }) => (
  <div className='max-w-[320px] border border-gray-200 justify-between rounded-lg bg-gradient-to-tr from-gray-200/70 dark:from-black to-gray-100 dark:to-gray-900 dark:border dark:border-gray-800 shadow-lg p-8 '>
    <Icons.stripeLinkLogo className='rounded' />
    <div className='mt-6 font-mono text-content whitespace-nowrap'>{paymentMethod.link?.email ?? 'ja@example.com'}</div>
...
const FallbackPaymentMethod: React.FC<UserPaymentMethodType> = ({ paymentMethod }) => (
  <div className='max-w-[320px] border border-gray-200 justify-between rounded-lg bg-gradient-to-tr from-gray-200/70 dark:from-black to-gray-100 dark:to-gray-900 dark:border dark:border-gray-800 shadow-lg p-8 '>
    <div className='font-mono text-sm text-content'>{paymentMethod.billing_details.name ?? 'Anonymous'}</div>
...
const MissingPaymentMethod: React.FC = () => (
  <div className='relative aspect-[86/54] max-w-[320px] border border-gray-200 justify-between rounded-lg bg-gradient-to-tr from-gray-200/70 dark:from-black to-gray-100 dark:to-gray-900 dark:border dark:border-gray-800 shadow-lg p-8'>
    <div className='z-50 mt-16 font-mono text-content whitespace-nowrap blur-sm'>•••• •••• •••• ••••</div>
