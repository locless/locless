...
import { VariableList } from './client';
import { useConvexAuth, useMutation, useQuery } from 'convex/react';
import { api } from '@repo/backend/convex/_generated/api';
import { useEffect } from 'react';
import { Loading } from '@/components/dashboard/loading';
import { DesktopTopBar } from '../desktop-topbar';
import { CreateVariableButton } from './buttons/create-variable';
import { CreateVariableGroupButton } from './buttons/create-variable-group';
        ...
        <>
            ...
            <div className='p-4 border-l bg-background border-border w-full flex-1 lg:p-8'>
                <PageHeader
                    ...
                    actions={[
                        <CreateVariableGroupButton workspaceId={workspace?._id} disabled={unpaid} />,
                        <CreateVariableButton workspaceId={workspace?._id} disabled={unpaid} />,
                    ]}
                />
                ...
                {unpaid ? (
                    ...
                    <VariableList workspaceId={workspace?._id} />
                )}
            </div>
        </>
    );
