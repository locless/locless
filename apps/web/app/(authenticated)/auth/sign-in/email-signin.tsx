      ...
      <form className='grid gap-2' onSubmit={signInWithCode}>
        <div className='grid gap-1'>
          <Input
            ...
            autoCorrect='off'
            required
            className='border-gray-300 bg-gray-50 bg-background'
          />
        </div>
        <Button className='bg-black border-black text-white hover:bg-gray-100 hover:text-black' disabled={isLoading}>
